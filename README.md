...
Реальные ответы и логи — в разделах [«Скриншоты»](#скриншоты) и
[«Логи»](#логи-демо-прогон) ниже.

## Скриншоты

Ответы сервиса в Streamlit (LLM-режим, `openai/gpt-oss-120b:free` через OpenRouter):

**1. «В каком году истекает договор аренды Байконура?» → «...действует до 2050 года [2]»**

![Байконур](doc/img/rag_example_1.png)

**2. «чем представлены органические остатки?» → ответ с цитатой [1] (doc_id=0, rerank≈0.94)**

![Органические остатки](doc/img/rag_example_2.png)

**3. «из чего состоят белки?» → «из α-аминокислот, пептидной связью [1]» (doc_id=1575)**

![Белки](doc/img/rag_example_3.png)

**4. Negative: «как приготовить борщ?» → отказ (нет в корпусе)**

![Отказ на borщ](doc/img/rag_example_4_neg.png)
